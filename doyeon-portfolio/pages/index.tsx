...
const Home: NextPage = () => {
  return (
    <div className="  mx-auto max-sm:w-4/5 max-xl:w-2/3 xl:w-1/3">
      <div className="">
      ...
      <ul className="flex flex-col mt-40 text-xl space-y-12 max-sm:mt-12 max-sm:text-base max-sm:space-y-10 list-disc marker:text-teal-500 break-keep sm:space-y-7 sm:mt-20 ">
        ...
        <li>
          코드는 최대한 <b className="text-teal-500">짧고 간결함을</b> 추구하는{" "}
          <b className=""> 심플 추구 개발자</b>
        </li>
      </ul>
      ...
      <div className="mt-24 mb-28 max-sm:mt-16 sm:mt-18">
        ...
        <div className="flex mt-20 max-sm:flex-col sm:flex-col lg:flex-row max-sm:mt-14 border-b-2 pb-16">
          ...
          <div className="max-sm:mt-8">
            <span className="text-xl underline max-sm:text-base ">
              ...
              라이브스트림을<br className="lg:hidden sm:hidden"></br> 할 수 있는
        ...
        <div className="flex mt-20 max-sm:flex-col sm:flex-col lg:flex-row max-sm:mt-14 border-b-2 pb-16 ">
          ...
          <div className="max-sm:mt-8 ">
            <span className="text-xl underline max-sm:text-base">
              유튜브를 모델로 한<br></br>동영상 녹화, 업로드, 감상을 할 수 있는
              <br></br>웹 서비스 개발
            </span>
            <h2 className="mt-14 text-2xl font-bold max-sm:mt-10 max-sm:text-xl sm:mb-5">
              Purpose.
        ...
        <div className="mt-24 max-sm:mt-16 ">
          ...
          <div className="">
            ...
            <div className="flex mt-14  max-sm:mt-14 border-b-2 pb-10">
              <div className="flex flex-col w-1/4 mr-10 max-sm:w-1/2 sm:w-1/2 lg:w-1/3 ">
                <span className="text-3xl font-bold max-sm:text-3xl">Env.</span>
              </div>
              <div>
                <ul className="text-lg list-disc marker:text-teal-500">
                  <li>Mac</li>
            ...
            <div className="flex mt-14 max-sm:mt-14 border-dashed border-b-2 pb-10 ">
              <div className="flex flex-col w-1/4 mr-10 max-sm:w-1/2 sm:w-1/2 lg:w-1/3 ">
                <span className="text-3xl font-bold max-sm:text-3xl">etc.</span>
              </div>
              <div>
                <ul className="text-lg list-disc marker:text-teal-500">
                  <li>Cloudflare</li>
